  ...
  return (
    <div className={`navbar_    navbar navbar-light navbar-expand`}>
      <Link className="navbar-brand p-0" to="/">
        <img src={logo} height="50px" alt="Logo página principal" />
      </Link>
      ...
      {currentUser ? (
        <React.Fragment>
          ...
          >
            <h4 className="pt-1 h3 mb-0 pl-2">
              {usersArray.filter((user) => user.active.label === "Sim").length}
              <small>/{usersArray.length}</small>
          <span className="hide__lg"> Membros</span><div className="hide">Ver</div>
            </h4>
          </Link>
          ...
          <div className="navbar__container   collapse navbar-collapse">
            ...
            <Link
              ...
              to="/form-parts"
              aria-label="Formulário de cadastramento rápido"
            >
            ...
            <div className="dropdown">
              ...
              >
                ...
                <div className="dropdown-item disabled_   my-2" to="/settings">
                  Configurações
                </div>
